...
class NextDayCalculator3Test {
    ...
    void display() {
        ...
        int[] result = NextDayCalculator3Test.display(1,1,2018);
    ...
    void display1() {
        ...
        int[] result = NextDayCalculator3Test.display(28,2,2000);
        assertArrayEquals(expected, number);
    }
    ...
    void display2() {
        ...
        int[] result = NextDayCalculator3Test.display(30,4,2005);
        assertArrayEquals(expected, number);
    }
    ...
    void display3() {
        ...
        int[] result = NextDayCalculator3Test.display1(29,2,2000);
        assertArrayEquals(expected, number);
    }
    ...
    void display4() {
        ...
        int[] result = NextDayCalculator3Test.display1(28,2,2000);
        assertArrayEquals(expected, number);
    }
    ...
    void display5() {
        ...
        int[] result = NextDayCalculator3Test.display1(14,6,2006);
        assertArrayEquals(expected, number);
    }
}
